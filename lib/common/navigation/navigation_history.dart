...
class NavigationHistoryObserver extends NavigatorObserver {
  ...
  /// Gets the top route name in the navigation stack.
  String? get topRouteName => _history.last?.settings.name;

  /// Gets the bottom route in the navigation stack.
  Route<dynamic>? get bottom => _history.first;

  /// Gets the bottom route name in the navigation stack.
  String? get bottomRouteName => _history.first?.settings.name;
