...
class AppDepartmentWidget extends StatefulWidget {
  const AppDepartmentWidget({super.key});

  @override
  State<AppDepartmentWidget> createState() => _AppDepartmentWidgetState();
}

class _AppDepartmentWidgetState extends State<AppDepartmentWidget> {
  ...
  void _onAdd() {
    ...
    if (validated) {
      ...
      context.read<DepartmentAddCubit>().addData(data: body);
    } else {
      CustomToast.error(message: "Please enter department name");
    }
  }
    ...
    return Scaffold(
      ...
      body: SafeArea(
        ...
        child: LoadingOverlay(
          ...
          child: BlocListener<DepartmentAddCubit, DataState>(
